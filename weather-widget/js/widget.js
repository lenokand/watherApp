    ...
    let content = `
            <div class="weatherWidget-header">
                ...
                <button class="weatherWidget-header__reload">
                    <img src="weather-widget/img/refresh.svg" alt="reload weather">
                </button>
            </div>
            ...
            <div class="weatherWidget-footer">
                <div class="weatherWidget-footer__wind">
                    <img src="weather-widget/img/arrow.svg" alt="wind direction" style="transform: rotate(${data.wind.deg}deg)">
